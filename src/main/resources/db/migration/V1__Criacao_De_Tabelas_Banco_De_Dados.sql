...
CREATE TABLE IF NOT EXISTS TB_AGENDAMENTO_DE_SERVICO (
...
CREATE TABLE IF NOT EXISTS TB_CARTAO_DE_CREDITO (
  id_cartao_pagamento INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS TB_SERVICO_CONTRATADO (
  ...
  CONSTRAINT fk_TB_SERVICO_CONTRATADO_AGENDAMENTO_DE_SERVICO1
    FOREIGN KEY (id_agendamento)
    REFERENCES TB_AGENDAMENTO_DE_SERVICO (id_agendamento)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
